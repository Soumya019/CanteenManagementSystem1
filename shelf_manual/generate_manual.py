...
SECTIONS = [
    ...
    ("Casing-Capping, Conduit & Metal Boxes", "#5D4037", [
        # per-piece rates below are the shop's own counter rates, pencilled
        # on each carton as "@ 03/=" — they override the printed box MRP
        item("1 Inch Casing Internal Bend", 3, "pc", "connector", None, "1 IN",
             sub="Ajonta ivory push-fit — 100 pcs/box, box marked @3/="),
        item("1 Inch Casing External Bend", 3, "pc", "connector", None, "1 IN",
             sub="Ajonta ivory push-fit — 100 pcs/box, box marked @3/="),
        item("1 Inch Casing Elbow", 3, "pc", "connector", None, "1 IN",
             sub="Ajonta ivory push-fit — 100 pcs/box, box marked @3/="),
        item("1 Inch Casing Tee", 3, "pc", "connector", None, "1 IN",
             sub="Ajonta ivory push-fit — 100 pcs/box, box marked @3/="),
        item("20x25mm Casing Elbow (3/4 Inch)", 2, "pc", "connector", None,
             "20X25", sub="Ajonta ivory push-fit — 100 pcs/box, box marked @2/="),
        item("20x25mm Casing Tee (3/4 Inch)", 2, "pc", "connector", None,
             "20X25", sub="Ajonta ivory push-fit — 100 pcs/box, box marked @2/="),
        item("20x25mm Casing Internal Bend (3/4 Inch)", 3, "pc", "connector",
             None, "20X25",
             sub="Ajonta ivory push-fit — 100 pcs/box, box marked @3/="),
        item("20x25mm Casing External Angle (3/4 Inch)", 3, "pc", "connector",
             None, "20X25",
             sub="Ajonta ivory push-fit — 100 pcs/box, box marked @3/= "
                 "(revised up from @2½/=)"),
